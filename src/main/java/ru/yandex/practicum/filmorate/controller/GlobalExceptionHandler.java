// Пример GlobalExceptionHandler для централизованной обработки исключений и возврата правильных HTTP-кодов
// Этот класс обычно находится в пакете controller или exception.
